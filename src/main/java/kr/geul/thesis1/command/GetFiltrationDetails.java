...
public class GetFiltrationDetails extends Command {
...
static boolean isRunOnServer = false;
	...
	public GetFiltrationDetails(ArrayList<String> arguments) {
		super(arguments);	
	}
...
//		RMI.initialize();
		...
		for (int year = yearBegin; year < yearEnd; year++) {
			...
			for (int month = monthBegin; month < monthEnd; month++) {
				...
				enterCommand("getf_log " + isRunOnServer + " " + year + " " + month + ";");
